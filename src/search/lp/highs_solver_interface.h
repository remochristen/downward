...
public:
    ...
    virtual void set_constraint_lower_bound(int index, double bound, bool flag=0) override;
    virtual void set_constraint_upper_bound(int index, double bound, bool flag=0) override;
